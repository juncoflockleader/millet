...
- Current slice: manifest-backed read-only browser panel with previews, kind filters, generated metadata, and usage/dependency labels for card portraits and VFX sheets.
