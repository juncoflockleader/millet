...
- `Cards` opens the ruleset card template studio for local template JSON drafts, type filters, dependency health, card preview, behavior/text sync, generated UX hint review, frame/art crop editing, property badge layout editing, equipment slot/stat/action editing, and guarded catalog promotion.
